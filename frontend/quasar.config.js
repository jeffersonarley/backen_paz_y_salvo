...
export default defineConfig((/* ctx */) => {
  return {
    ...
    // Se reorganizo la carpeta de Pinia de "src/stores" a "src/store"
    // (para igualar la estructura de la guia del profesor), por eso hay
    // que decirle a Quasar CLI donde quedo el punto de entrada del store.
    sourceFiles: {
