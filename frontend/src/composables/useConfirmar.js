 ...
 *
 *   if (await confirmar({ titulo: 'Eliminar', mensaje: '¿Seguro?' })) { ... }
 *
 * Sin este composable, cada pantalla (Contratistas, Supervisores, Usuarios...)
 * tendria que repetir el $q.dialog completo.
 */
